...
# fmt: off
LLAMA_MODELS_ROOT = Path(__file__).parent.resolve()
LLAMA2_MODELS = {
    # === Pure Meta LLaMa-2 (non-instruct/chat-tuned) Models ===
    "llama2-7b-pure": {
        "llm_family": "llama2", "llm_cls": LlamaForCausalLM, "hf_hub_path": str(LLAMA_MODELS_ROOT / "llama2_config"),
    },

    "llama2-13b-pure": {
        "llm_family": "llama2", "llm_cls": LlamaForCausalLM, "hf_hub_path": "NousResearch/Llama-2-13b-hf",
    },

    # === Meta LLaMa-2 Chat Models ===
    "llama2-7b-chat": {
        "llm_family": "llama2", "llm_cls": LlamaForCausalLM, "hf_hub_path": "NousResearch/Llama-2-7b-chat-hf",
    },

    "llama2-13b-chat": {
        "llm_family": "llama2", "llm_cls": LlamaForCausalLM, "hf_hub_path": "NousResearch/Llama-2-13b-chat-hf",
    },
