...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [
        ...
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS & EEF_R6 & ABS_EEF_POS actions supported! ")
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.ABS_EEF_POS:
