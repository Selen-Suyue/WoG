...
def get_dataset_statistics(
    ...
    # Use the parent directory of the current project root (assumed to be 6 levels up from this file)
    project_parent_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../../../.."))
    local_path = os.path.join(project_parent_dir, ".cache", "orca", f"dataset_statistics_{unique_hash}.json")
