...
# === WoG-VLA Pretraining Configs ===


@dataclass
class Exp_WoG_OXE_Magic_Soup_Plus_Minus(Exp_SigLIP_224px_Bridge):
...
class VLARegistry(Enum):
    ...
    # === WoG-VLA Pretraining Configs ===
    EXP_WoG_OXE_MAGIC_SOUP_PLUS_MINUS = Exp_WoG_OXE_Magic_Soup_Plus_Minus
